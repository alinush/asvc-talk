...
\long\def\beamer@date[#1]#2{%
    \def\insertdate{#2%
        \\
        \vspace{1em}
        {\scriptsize \textit{While you're at it, feel free to read our \href{https://alinush.github.io/2020/05/06/aggregatable-subvector-commitments-for-stateless-cryptocurrencies.html}{\textcolor{TolDarkBlue}{blogpost}} too.}}%
    }%
    \def\beamer@shortdate{#1}%
}
\makeatother
\date{\centering May 20th, 2020}
